...
import {
  ...
  StartHour,
  WeekCellsHeight,
} from "@event-calendar-utils/constants";
import { isMultiDayEvent } from "@event-calendar-utils/utils";
import {
  addHours,
...
import { useCurrentTimeIndicator } from "@event-calendar-hooks/use-current-time-indicator";
